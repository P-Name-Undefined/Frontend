...
export const DefaultButton = ({
    ...
    const variantStyle = {
        ...
        elevated: {
            pressableStyle: 'bg-white shadow-md shadow-black shadow-opacity-50',
    ...
    return (
        <Pressable
            onPress={onPress}
            style={tw`rounded-md bg-primary ${width} ${pressableStyle} ${buttonSize[size]} ${disabledStyle} flex-row justify-center items-center`}
            disabled={disabled}
            android_ripple={{
        ...
        >
            {isLoading ? (
                ...
                <>
                    ...
                    <Text
                        style={tw`text-center text-light font-ms-semibold text-lg ${textStyle}`}
                    >
                        {title}
                    </Text>
                </>
